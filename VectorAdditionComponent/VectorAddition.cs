...
{
    class VectorAddition : IComponent
    {
        ...
        public VectorAddition()
        {
            ...
            this.friendlyName = "Vector Addition";
            ...
            this.outputDescriptions = new List<string>() { "An integer array, which represents the sum of the two vectors." };   
        }
